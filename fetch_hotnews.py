# -*- coding: utf-8 -*-
"""
投研工作台 v16 · 今日热点推送 + 二级页《盘点今日热点》 真实数据源（每日 08:30 自动运行）
...
REPO  = r"G:/Workbuddy/publish/touyan-workbench-app-v16"
...
WEAK = {
    ...
    "文化": ["社会", "民生", "消费", "生活", "商业", "人事", "教育", "医疗", "文娱", "网红", "票房", "综艺", "明星", "体育", "旅游", "就业", "养老"],
}
...
KW = {
    ...
    "文化": ["电影","电视剧","综艺","音乐","歌手","演员","明星","票房","春晚","世界杯","奥运","赛事","体育","影视","演唱会","网红","动漫","游戏","专辑","节目","上映","主演","导演","影迷","观影","开播","收官","夺冠","总决赛","开赛","新歌","单曲"],
...
def main():
    ...
    print("PUSHED -> qiao3412-cmd.github.io/touyan-workbench-app-v16")
